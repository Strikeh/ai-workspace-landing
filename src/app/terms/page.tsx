        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <section>
            <p className="text-lg leading-relaxed" style={{ color: "var(--color-text)" }}>
              Welcome to AI Workspace. By installing and using this extension, you agree to these Terms of Service. 
          ...
          <section>
            ...
            <p style={{ color: "var(--color-text)" }}>
              By downloading, installing, or using AI Workspace, you agree to be bound by these Terms of Service 
              and our Privacy Policy. If you do not agree to these terms, please do not use the extension.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2" style={{ color: "var(--color-text-secondary)" }}>
              <li>Local storage and organization of AI prompts, conversations, and notes</li>
            ...
            <p className="mt-4" style={{ color: "var(--color-text)" }}>
              All data processing happens locally on your device unless explicitly stated otherwise.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2" style={{ color: "var(--color-text-secondary)" }}>
              ...
              <li>Not interfere with or disrupt the extension&rsquo;s functionality</li>
              <li>Maintain the security of your local data and encryption passwords</li>
              <li>Comply with the terms of service of third-party platforms (ChatGPT, Claude, Grok)</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6" style={{ color: "var(--color-accent)" }}>
              4.1 Free Version
            </h3>
            <p style={{ color: "var(--color-text)" }}>
              The free version provides limited access to core features including basic prompt storage, 
              one vault, and standard functionality.
            </p>
          ...
          <section>
            ...
            <p style={{ color: "var(--color-text)" }}>
              AI Workspace and all related content, features, and functionality are owned by AI Workspace 
          ...
          <section>
            ...
            <p style={{ color: "var(--color-text)" }}>
              We strive to provide reliable service, but we do not guarantee that the extension will be 
              uninterrupted, secure, or error-free. We may modify, suspend, or discontinue any feature 
            ...
            <p style={{ color: "var(--color-text)" }}>
              AI Workspace integrates with third-party platforms (ChatGPT, Claude, Grok). We are not 
              responsible for changes to these platforms that may affect the extension&rsquo;s functionality.
            </p>
            ...
            <p style={{ color: "var(--color-text)" }}>
              While we implement security measures, we are not responsible for data loss due to browser 
              issues, device failures, or user error. You are responsible for backing up important data.
            </p>
            ...
            <p style={{ color: "var(--color-text)" }}>
              To the maximum extent permitted by law, AI Workspace shall not be liable for any indirect, 
          ...
          <section>
            ...
            <p style={{ color: "var(--color-text)" }}>
              ...
              significant changes through the extension or our website. Continued use of the extension 
          ...
          <section>
            ...
            <p style={{ color: "var(--color-text)" }}>
              We may terminate or suspend your access to the extension immediately, without prior notice, 
          ...
          >
            ...
            <p style={{ color: "var(--color-text)" }}>
              In plain language: Use AI Workspace responsibly, respect our intellectual property, 
              understand that all data is stored locally on your device, and know that we may update 
              these terms as needed. Your privacy and security are our top priorities.
            </p>
          </section>
        </div>
      </article>
