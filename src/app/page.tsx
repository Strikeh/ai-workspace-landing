...
export default function Home() {
  ...
  const [tangentVideoOpen, setTangentVideoOpen] = useState(false);
        ...
        >
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <ScaleUp className="relative" delay={0.2}>
                <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-slate-900/50 backdrop-blur-xl aspect-video group">
                  ...
                  {/* Tangent View demo — click to enlarge */}
                  <div
                    className="relative w-full h-[calc(100%-48px)] cursor-zoom-in"
                    onClick={() => setTangentVideoOpen(true)}
                  >
                    <video
                      src="/videos/tangent-demo.mp4"
                      poster="/videos/tangent-demo-poster.jpg"
                      autoPlay
                      muted
                      loop
                      playsInline
                      preload="metadata"
                      aria-label="Tangent View demo"
                      className="absolute inset-0 h-full w-full object-cover pointer-events-none"
                    />
                    {/* Enlarge hint overlay */}
                    <div className="pointer-events-none absolute inset-0 flex items-center justify-center bg-black/0 group-hover:bg-black/30 transition-colors duration-300">
                      <div className="opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 flex items-center gap-2 px-4 py-2 rounded-full bg-black/70 backdrop-blur-sm border border-white/15 text-white text-sm font-medium">
                        <svg
                          className="w-4 h-4"
                          fill="none"
                          viewBox="0 0 24 24"
          ...
          {tangentVideoOpen && (
            <div
              ...
              onClick={() => setTangentVideoOpen(false)}
            >
              <div
                className="relative w-full max-w-6xl aspect-video rounded-xl overflow-hidden shadow-2xl border border-white/10 cursor-default"
              ...
              <button
                className="absolute top-6 right-6 p-2 rounded-full bg-black/50 text-white hover:bg-white/20 transition-colors cursor-pointer"
                onClick={() => setTangentVideoOpen(false)}
                aria-label="Close"
              >
                <svg
              ...
              <StaggerItem className="relative p-8 rounded-3xl border border-cyan-500/50 bg-slate-900/80 backdrop-blur-md shadow-[0_0_40px_-10px_rgba(6,182,212,0.3)] flex flex-col h-full hover:shadow-[0_0_60px_-10px_rgba(6,182,212,0.4)] transition-all duration-500">
                ...
                <ul className="space-y-4 mb-8 flex-1">
                  {[
                    ...
                    {
                      text: "Message Notes & Bookmarks — save & jump back to any message",
                      badge: "NEW",
                    },
