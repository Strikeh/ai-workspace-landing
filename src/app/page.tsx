...
import { FadeIn, SlideUp, ScaleUp, StaggerContainer, StaggerItem } from "@/components/ScrollAnimation";
	...
	return (
		...
		>
			...
			<main>
				<section className="hero-section relative isolate overflow-hidden min-h-[90vh] flex items-center">
					...
					<div className="relative z-10 mx-auto flex max-w-7xl flex-col gap-16 px-6 pb-32 pt-20 md:px-10 lg:px-16">
						<div className="flex flex-col gap-12 lg:flex-row lg:items-center lg:justify-between">
							<SlideUp className="max-w-2xl space-y-8" delay={0.1}>
							...
							<ScaleUp className="relative w-full max-w-2xl lg:max-w-xl perspective-1000" delay={0.3}>
								{/* Glow behind video */}
				...
				>
					...
					<div className="mx-auto max-w-7xl px-6 md:px-10 lg:px-16 relative z-10">
						...
						<StaggerContainer className="bento-grid" staggerDelay={0.1}>
							...
							<StaggerItem className="bento-card col-span-1 md:col-span-2 lg:col-span-2 row-span-2">
							...
							<StaggerItem className="bento-card col-span-1 md:col-span-2 lg:col-span-3">
				...
				>
					<ScaleUp className="mx-auto max-w-4xl px-6 text-center">
						<h2
