      ...
      <article className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <section>
            ...
            >
              AI Workspace is designed with privacy and security in mind. This
              extension does not collect, store, or sell any personal data. All
              processing happens locally in your browser unless explicitly
              stated below.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4" style={{ color: "var(--color-text)" }}>
              We do not use analytics, tracking scripts, or third-party
              monitoring tools.
            </p>
          </section>
          ...
          <section>
            ...
            <ul
              className="list-disc list-inside space-y-3 mt-4"
              style={{ color: "var(--color-text-secondary)" }}
            >
              <li>
                Your ChatGPT conversations, accessible only when you are logged
                in and only to display and organize them locally inside the
                extension.
              </li>
              <li>
                Local storage (chrome.storage.local) to save your vaults,
                prompts, tags, and preferences.
              </li>
            </ul>
            <p
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <p style={{ color: "var(--color-text-secondary)" }}>
                  Used to save your vaults, prompts, preferences, and sync state
              ...
              >
                ...
                <p style={{ color: "var(--color-text-secondary)" }}>
                  Used to read your ChatGPT conversations only when you choose
                  to sync them. No data is sent anywhere—everything is processed
                  locally.
                </p>
              </div>
            </div>
            ...
            <p className="mt-4" style={{ color: "var(--color-text)" }}>
              AI Workspace does not modify or interfere with ChatGPT in any
              unauthorized way.
            </p>
          </section>
          ...
          <section>
            ...
            <p style={{ color: "var(--color-text)" }}>
              All data stored locally is handled securely using Chrome&rsquo;s
              built-in extension sandbox. We do not add any remote code or
